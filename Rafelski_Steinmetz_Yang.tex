...
\begin{document}
\markboth{Johann Rafelski, Andrew Steinmetz, and Cheng Tao Yang}{Dynamic neutrino flavor mixing through transition magnetic moments}
...
\bibliography{Rafelski_Steinmetz_Yang}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\end{document} 